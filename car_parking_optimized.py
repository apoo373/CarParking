...
class ParkingLot:
    def __init__(self, capacity):
        ...
        self.EmptySlots = range(0, capacity)
        heapq.heapify(self.EmptySlots)

    # Function to Park a Vehicle
    def ParkVehicle(self, Vehicle):
        """This Function Parks a Vehicle if Slots are present. Worst Case O(1)"""
        ...
        emptySlot = heapq.heappop(self.EmptySlots)
    ...
    def RemoveVehicle(self, slotNumber):
        ...
        heapq.heappush(self.EmptySlots, slotNumber-1)
    ...
    def RetrieveSlotsWithGivenColor(self, color, printRes = False):
        "Get All Slots which have cars parked with the given color. Worst Case O(1)"
